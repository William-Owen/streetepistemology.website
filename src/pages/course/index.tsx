	...
	return (
		...
		<div className={rootClassName}>
			...
			<Page className={style.courseIntroduction}>
				...
				<p>The Street Epistemology courses are designed to help people to learn Street Epistemology at their own pace. We have an incredibly talented and dedicated project team eager to build something profound for others.</p>
			...
			<section className={style.courses}>
				...
				<div className={style.courseListing}>
					...
					{Object.keys(courses).map(courseKey=>{
						...
						const {html, courseTitle,slug, moduleCount, moduleCollection} = course
							...
							<>
								...
								{moduleCollection ?
									...
									<Link className={style.course} to={slug}>
										...
										{moduleCollection && <CourseModuleCount moduleCount={moduleCount} />}
